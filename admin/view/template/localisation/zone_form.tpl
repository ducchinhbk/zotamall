      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-zone" class="form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="parent_id" id="input-country" class="form-control">
                <option value="0" selected="selected">Choose parent</option>
                <?php foreach ($parents as $parent) { ?>
                <?php if ($parent['zone_id'] == $parent_id) { ?>
                <option value="<?php echo $parent['zone_id']; ?>" selected="selected"><?php echo $parent['name']; ?></option>
                <?php } else { ?>
                <option value="<?php echo $parent['zone_id']; ?>"><?php echo $parent['name']; ?></option>
                <?php } ?>
                <?php } ?>
              </select>
            </div>
