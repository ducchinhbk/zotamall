...
$(document).ready(function() {
    ...
    $(":input[name='category_description[1][name]']").keyup(function(){
        $(":input[name='keyword']").val(remove_vietnamese_accents($(this).val())); 
    });
    
    $(":input[name='name']").keyup(function(){
        $(":input[name='link']").val(remove_vietnamese_accents($(this).val())); 
    });
