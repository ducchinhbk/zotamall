...
<head>
    ...
    <link href="<?php echo DIR_APP_NAME ?>/view/stylesheet/detail2.css" rel="stylesheet">
    <link href="<?php echo DIR_APP_NAME ?>/view/stylesheet/detail.css" rel="stylesheet">
    <link href="<?php echo DIR_APP_NAME ?>/view/stylesheet/style.css" rel="stylesheet">
    ...
    <link href="<?php echo DIR_APP_NAME ?>/view/stylesheet/jquery.jqzoom.css" rel="stylesheet">
    ...
    <script src="<?php echo DIR_APP_NAME ?>/view/javascript/jquery.jqzoom-core.js"></script>
    <script src="<?php echo DIR_APP_NAME ?>/view/javascript/jquery.countdown.min.js"></script>
            ...
            <div id="prdMedia" class="prd-media">
                ...
                <div class="clearfix" id="content" >
                    <div class="clearfix thumb-pri">
                        <a href="image/catalog/imgProd/triumph_big1.jpg" class="jqzoom" rel='gal1'  title="triumph" >
                            <img src="image/catalog/imgProd/triumph_small1.jpg"  title="triumph">
                        </a>
                    </div>
                    <br/>
                    <div class="clearfix thumb-list" >
                        <ul id="thumblist" class="clearfix" >
                            <li><a class="zoomThumbActive" href='javascript:void(0);' rel="{gallery: 'gal1', smallimage: './image/catalog/imgProd/triumph_small1.jpg',largeimage: './image/catalog/imgProd/triumph_big1.jpg'}"><img src='image/catalog/imgProd/thumbs/triumph_thumb1.jpg'></a></li>
                            <li><a href='javascript:void(0);' rel="{gallery: 'gal1', smallimage: './image/catalog/imgProd/triumph_small2.jpg',largeimage: './image/catalog/imgProd/triumph_big2.jpg'}"><img src='image/catalog/imgProd/thumbs/triumph_thumb2.jpg'></a></li>
                            <li><a  href='javascript:void(0);' rel="{gallery: 'gal1', smallimage: './image/catalog/imgProd/triumph_small3.jpg',largeimage: './image/catalog/imgProd/triumph_big3.jpg'}"><img src='image/catalog/imgProd/thumbs/triumph_thumb3.jpg'></a></li>
                        </ul>
                    </div>
                </div>
            </div>
