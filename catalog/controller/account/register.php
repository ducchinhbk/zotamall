...
class ControllerAccountRegister extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->custom_link('account/success'));
		}
		...
		$data['action'] = $this->url->custom_link('account/register');
        $data['login'] = $this->url->custom_link('account/login');
