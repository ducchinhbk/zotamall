...
<div class="contentright">
    ...
    <div class="boxright6">
    	<span class="boxrighttitle fl w100pc mt10"><?php echo get_cat_name((int)$relateCats[0]);?></span>
    	<ul class="most-view">
            <?php $i = 1;
            $args = array(
	...
	<div class="boxright2"> 
		<span class="boxrighttitle"><a href="<?php echo esc_url(get_category_link((int)$relateCats[1]))?>" title="<?php echo get_cat_name((int)$relateCats[1]);?>"><?php echo get_cat_name((int)$relateCats[1]);?></a></span> 
		<div class="topright2"> 
	...
	<div class="boxright3">
		<span class="boxrighttitle">
			<a href="<?php echo esc_url(get_category_link((int)$relateCats[2]))?>" title="<?php echo get_cat_name((int)$relateCats[2]);?>"><?php echo get_cat_name((int)$relateCats[2]);?></a>
		</span>
		<div class="topright3">
			<ul> 
                <?php  $i = 0;
 ...
 <div class="boxright5">
	<span class="boxrighttitle"><a href="<?php echo esc_url(get_category_link((int)$relateCats[3]))?>" title="<?php echo get_cat_name((int)$relateCats[3]);?>"><?php echo get_cat_name((int)$relateCats[3]);?></a></span>
	<ul>
        <?php  
            $args = array(
