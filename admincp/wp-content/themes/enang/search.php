				...
				<div id="homecenterNews"  class="centerNews col-sm-9 col-md-7 col-lg-7" >
					...
					<div id="gotoCenter" class="mainCt">
							<div class="navMainCt search">
								<h2 class="title-h2" style="color: #000;">Kết quả tìm kiếm với từ khóa: &nbsp;&nbsp;<span> "<?php echo get_search_query(); ?>"</span></h2>
							</div><!-- end navMainCt-->
							<div id="contentBox">
								<div id="nang-tabs_hot_newest" class="activeBox nang_wtt"> 
                                <input class="query-str" id="query-str" type="hidden" value="<?php echo get_search_query(); ?>"> 
